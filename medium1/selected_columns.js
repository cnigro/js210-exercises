...
// we need to use the let keyword instead of var, because var has function scope
// and therefore only creates one length variable. let has block scope, so it
// will created a new length variable for each for loop